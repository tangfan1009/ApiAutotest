...
class BaseRequests:
    ...
    def get(self, url, **kwargs):
        '''
        封装request中的get方法，增加打印，增加异常处理，使用session发送请求
        :param url:
        :param kwargs:
        :return:
        '''
    ...
    def post(self, url, data=None, json=None, **kwargs):
        try:
            ...
            print(f"发送请求，url:{url},请求参数data：{data},json：{json},其他参数：{kwargs}成功。")
            return r
        except Exception as e:
            print(f"发送请求，url:{url},请求参数data：{data},json：{json},其他参数：{kwargs}异常，异常信息为：{e}")
